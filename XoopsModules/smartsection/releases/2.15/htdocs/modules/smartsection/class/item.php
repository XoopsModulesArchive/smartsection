...
*/
	...
	<input type="hidden" name="business" value="d.sless@communication.org.au"> 
	<input type="hidden" name="item_name" value="2010 Individual Member">
	<input type="hidden" name="item_number" value="25">
	<input type="hidden" name="amount" value="100">
	<input type="hidden" name="rm" value="2">
	<input type="hidden" name="notify_url" value="'.XOOPS_URL.'/modules/profile/ipnppd.php">
	<input type="hidden" name="no_shipping" value="1">
	<input type="hidden" name="currency_code" value="USD">
	<input type="hidden" name="cn" value="Comments">
	<input type="hidden" name="custom" value="'.$GLOBALS['xoopsUser']->getVar('uid').'">
	<input type="hidden" name="cancel_return" value="'.XOOPS_URL.'">
	<input type="hidden" name="return" value="'.$_SERVER['REQUEST_URI'].$_SERVER['QUERY_STRING'].'">
	<input type="hidden" name="image_url" value="'.XOOPS_URL.'/images/logo_paypal.jpg"><br>
	<input type="submit" value="Become a Member now" border="0" name="I1"></form>';
			else
				$paypal= '<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
	<input type="hidden" name="cmd" value="_xclick">
	<input type="hidden" name="business" value="d.sless@communication.org.au"> 
