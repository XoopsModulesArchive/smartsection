...
define('_MI_SSECTION_HTACCESS', '.htaccess SEO');
define('_MI_SSECTION_HTACCESSDSC', 'Enable .htaccess SEO as per configured!');
define('_MI_SSECTION_BASEPATH', 'SEO base path:');
define('_MI_SSECTION_BASEPATHDSC', 'Start of the url for SEO!');
define('_MI_SSECTION_ENDOFURL_HTML', 'HTML Extension');
define('_MI_SSECTION_ENDOFURL_HTMLDSC', 'End extension of a php/html SEO URL!');
define('_MI_SSECTION_ENDOFURL_PDF', 'PDF Extension');
define('_MI_SSECTION_ENDOFURL_PDFDSC', 'End extension of a pdf SEO URL');
