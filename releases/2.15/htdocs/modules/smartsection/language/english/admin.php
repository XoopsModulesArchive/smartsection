...
define("_AM_SSECTION_HITS", "Hits 2008-9");
...
define("_AM_SSECTION_PARTIAL_VIEWDSC", "If a group has read permission for this article, you can limit that group to partial view access (will only be able to read the summary) by checking the group's checkbox here. Please note that these groups also need to have module access permission and parent category read permission.");
